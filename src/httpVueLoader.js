(function umd (root, factory) {
	...
	Component.prototype = {
		...
		load: function (componentURL, payload) {
			return httpVueLoader.httpRequest(componentURL, payload)
	...
	httpVueLoader.load = function (url, name, payload) {
		return function () {
			return new Component(name).load(url, payload)
	...
	httpVueLoader.register = function (Vue, url, payload) {
		var comp = parseComponentURL(url)
		Vue.component(comp.name, httpVueLoader.load(comp.url, comp.name, payload))
	}
	...
	function httpVueLoader (url, name, payload) {
		var comp = parseComponentURL(url)
		return httpVueLoader.load(comp.url, name, payload)
	}
